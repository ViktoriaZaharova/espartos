...
function calculate_wallpaper_height(){
	...
	if($wallpaper_info_block.length){
		...
		$('.detail_wrp .main_info_wrp .wallpaper_image_wrp').css({'height': block_height < 700 ? 700 : block_height});
	}
}
...
$(document).ready(function(){
	/* ↓ LONG_NAME ↓ */
	$('.catalog_main_list').children().each(function(){
		...
		if(text_height>60){
			closest_li.addClass('smaller_name');
		}
	});
	/* ↑ LONG_NAME ↑ */
