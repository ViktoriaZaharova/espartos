...
$(document).ready(function(){
	...
	$('#upload_image_popup_wrp').find('.uploading_btn').click(function(){
		$('.photowalltater_form_wrp').find('.image_upload_btn_wrp').addClass('uploaded');
	});
	$('.photowalltater_form_wrp').find('.send_data_btn').click(function(){
		$(this).closest('.fields_wrp').slideUp(100).siblings('.done').slideDown(100);
	});
	/* ↑ Пример загрузки файлов ↑ */
	
	/* ↓ Пример калькулятора ↓ */
	$('.calc_photowallpaper_cost_form_wrp').find('.lets_calc_btn').click(function(){
		$(this).closest('.calc_photowallpaper_cost_form_wrp').slideUp(100).siblings('.result_photowallpaper_cost_form_wrp').slideDown(100);
	});
	$('.result_photowallpaper_cost_form_wrp').find('.back_to_calc_btn').click(function(event){
		event.preventDefault();
		$(this).closest('.result_photowallpaper_cost_form_wrp').slideUp(100).siblings('.calc_photowallpaper_cost_form_wrp').slideDown(100);
	});
	/* ↑ Пример калькулятора ↑ */
	...
	*/
	...
	$('.upload_image_popup_btn').click(function(){$('#upload_image_popup_wrp').fadeIn(500);});
