...
$(document).ready(function(){
	...
	$('.delivery_popup_btn_gtd').click(function(){$('.delivery_popup.gtd').fadeIn(500);});
	$('.delivery_popup_btn_zel').click(function(){$('.delivery_popup.zel').fadeIn(500);});
	$('.delivery_popup_btn_sdek').click(function(){$('.delivery_popup.sdek').fadeIn(500);});
	$('.delivery_popup_btn_energia').click(function(){$('.delivery_popup.energia').fadeIn(500);});
	/* ↑ DELIVERY_POPUP ↑ */
