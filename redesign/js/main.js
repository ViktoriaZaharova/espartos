$( document ).ready(function() {
    ...
    $('.city_change_btn').click(function(){$('#city_change_popup').delay(200).fadeIn(500);});
    $('.add_to_basket_btn').click(function(){$('#added_to_basket_popup').delay(200).fadeIn(500);});
    $('.login_btn').click(function(){$('#login_popup').delay(200).fadeIn(500);});
    $('.reviews_photo_gallery_btn').click(function(){$('#reviews_photo_gallery').delay(200).fadeIn(500);});
    $('.delivery_adress_change_btn').click(function(){$('#delivery_adress_change_popup').delay(200).fadeIn(500);});
    /* ^ POPUP ^ */
