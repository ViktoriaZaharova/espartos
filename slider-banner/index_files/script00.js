...
$(document).ready(function(){
	...
	/* ↓ FILTER_SHOW_MORE ↓ */
	$('.filter_group').find('.show_all_btn').click(function(){
		var $filter_list = $(this).closest('.btns_wrp').siblings('.menu_filter_links_list');
		var $filter_list_height = $filter_list.outerHeight();
		$(this).closest('.filter_group').addClass('showed_all');
		$filter_list.css({'height':$filter_list_height - 50});
	});
	$('.filter_group').find('.hide_all_btn').click(function(){
		var $filter_list = $(this).closest('.btns_wrp').siblings('.menu_filter_links_list');
		$(this).closest('.filter_group').removeClass('showed_all');
